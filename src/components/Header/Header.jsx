                            ...
                            <div id="navegacion" className="collapse navbar-collapse">
                                <nav className="navbar-nav container d-flex flex-md-row text-center justify-content-md-end gap-2 gap-lg-5">
                                    <a className="nav_link"
                                        href="#header"><span className='separator_navLink'>|</span>{lang.home}</a>
                                    <a className="nav_link" href="#about"><span className='separator_navLink'>|</span>{lang.about}</a>
                                    <a className="nav_link"
                                        href="#services"><span className='separator_navLink'>|</span>{lang.services}</a>
                                    <a className="nav_link"
                                        href="#portfolio"><span className='separator_navLink'>|</span>{lang.portfolio}</a>
                                    <a className="nav_link" href="#contact"><span className='separator_navLink'>|</span>{lang.contact}</a>
                                </nav>
                            </div>
                        ...
                        <div className="col-md-10">
                            <div className="row">
                                ...
                                <div className="col-md-8 d-flex flex-column justify-content-center">
                                    <div>
                                        <h2 className="text-center text-white txt1">{lang.hi}</h2>
                                    </div>
                                    <div className="d-flex justify-content-center">
                                        <h1 className="text-center txt2"><span className="textox">I'm Jonathan Torres</span></h1>
                                    </div>
                                    <div className="d-flex justify-content-center">
                                        <h2 className="text-center text-white txt3">- Full <i className="fa-solid fa-up"></i>Stack Web Developer -</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
